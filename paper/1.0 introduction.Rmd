...
Commercial insurance programs are often depicted as "towers." (See Figure \ref{fig:tower}) The lowest floors of the tower are typically comprised of risk retained by the insured. The middle floors include commercially insured working layers. The "penthouse" is generally high-layer excess insurance. Each of these layers has a cost to it.

-   The cost of the lowest layers will have a reasonable degree of predictability. The cost for these layers will be principally be the expected loss with a minimal capital charge volatility. There may also be frictional costs associated with risk retention such as increased audit and actuarial fees and claims costs from legal counsel and third party claim administrators.
...
-   Insureds generally do not expect access coverage from the highest layers. The expected claims will likely be close to \$0. The coverage does not smooth claims volatility for the insured over time but rather smooths claim volatility across insured risks. There are often multiple insurers in these layers, each with a pro-rata share. 
