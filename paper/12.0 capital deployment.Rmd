...
-   The firm is subject to the loss events that result in aggregate claim
    amounts, $X$. We present distribution of claim amounts in Figure \@ref(fig:Claim-Distribution)[^1].
...
\begin{aligned}
E[R_I] &> E[R_0] \\
r_c \times (C - P) - P &> r_c \times CW_{0} + r_f \times CX_{0} \\
r_c \times C - r_c \times P - P &>  r_c \times CW_{0} + r_f \times CX_{0}\\
-P \times (1 + r_c) &> r_c \times CW_{0} + r_f \times CX_{0} - r_c \times C\\
-P \times (1 + r_c) &> r_c \times (CW_{0} - C) + r_f \times CX_{0}\\
-P  &> \dfrac{r_c \times (CW_{0} - C) + r_f \times CX_{0}}{1 + r_c}\\
-P &> \dfrac{r_c \times (CW_{0} - C) + r_f \times CX_{0}}{1 + r_c}\\
-P &> \dfrac{r_c \times (-CX_{0}) + r_f \times CX_{0}}{1 + r_c}\\
-P &> CX_{0} \times \dfrac{r_f - r_c}{1 + r_c}
