...
$$
\begin{aligned}
E[R_{I}] &= E[\dfrac{r_c \times (C - PX_{I}) - PX_{I}}{C}]\\
\\
Var[R_{I}] &= Var(\dfrac{r_c \times (C - PX_{I}) + r_f \times CX_{I} - X_{ret} - PX_{I}}{C})\\
...
\nonumber &=\frac{(C - PX_{I})\times r_c-PX_{I}-C \times rf}{C}\ / (\frac{Var(X_{ret})}{C^2})^{0.5}\\
&=\dfrac{C\times (r_c-r_f)-PX_{I} \times(1 + r_c)}{SD(X_{ret})}
\end{align}
...
\nonumber -PX_{I} \times(1 + r_c) &> \dfrac{SD(X_{ret})}{SD(X)} \times (r_c-r_f) \times (C - CX_{0} - C)\\
\nonumber -PX_{I} \times(1 + r_c) &> \dfrac{SD(X_{ret})}{SD(X)} \times (r_c-r_f) \times (-CX_{0})\\
\nonumber -PX_{I}  &> - CX_{0} \times \dfrac{(r_c-r_f)}{(1 + r_c)} \times \dfrac{SD(X_{ret})}{SD(X)}\\
PX_{I}  &< CX_{0} \times \dfrac{(r_c-r_f)}{(1 + r_c)} \times \dfrac{SD(X_{ret})}{SD(X)}
\end{align}

In interpreting this equation, we should recognize that the unlimited variance of claim amounts may be allocated between retained and excess (insured) components. As such, when the insured retains more risk, ....
