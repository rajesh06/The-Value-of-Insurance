...
When premiums amounts do not satisfy either equation (\ref{eqn:cap-deploy}) or equation (\ref{eqn:cap-deploy}), then the insurance transaction does not add financial value in excess of premiums. However, it may still provide value in supporting a restful night's sleep.
