...
to experience significant capital depletion. We denote this reserve as $C_x$, to
indicate that the reserve is a segregation of capital to absorb realizations of
$X$ that reduce $C$ below $C_m$. Effectively, the firm is insuring self-insuring
this risk but, unlike an insurer, it can not spread that risk across its insured
portfolio.

We present that capital allocation approach in Figure X.
...
### I write 2 possible ways to apply the penalty function, we can pick a better one
