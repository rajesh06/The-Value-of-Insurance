...
\nonumber r_c \times C - r_c \times P^{I} - P^{I} &>  r_c \times C_{w}^{0} + r_f \times C_{x}^{0}\\
\nonumber -P^{I} \times (1 + r_c) &> r_c \times C_{w}^{0} + r_f \times C_{x}^{0} - r_c \times C\\
\nonumber -P^{I} \times (1 + r_c) &> r_c \times (C_{w}^{0} - C) + r_f \times C_{x}^{0}\\
<!-- \nonumber -P^{I} &> \dfrac{r_c \times (C_{w}^{I} - C) + r_f \times C_{x}^{0}}{1 + r_c}\\ This was a duplicate in the original file--> 
\nonumber -P^{I} &> \dfrac{r_c \times (C_{w}^{0} - C) + r_f \times C_{x}^{0}}{1 + r_c}\\
